...
typedef struct threadpool {
    ...
    pthread_t* thread;
    int conta_celle;                // conto quanti elementi sono presenti nella coda
    int lunghezza;                  // lunghezza della coda
    Puntatore_file coda;
    char* ultimo_file;              // variabile per dire ai worker quando cambiare l'uscita dopo che il master ha finito di inserire i file nella coda
...
Threadpool* inizializza(int, int, char*);
